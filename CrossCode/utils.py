...
def getargs():
    ...
    # Required parameters
    parser.add_argument("--data_dir", default='your dataset dir', type=str,
                        help="data_dir")

    # NOTE: cross-project link recovery must rely on the models saved by in-project BTLink.
    parser.add_argument("--output_dir", default='your output path', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--result_dir", default='your result path', type=str,
    ...
    parser.add_argument("--code_model_path", default='microsoft/codebert-base', type=str,
